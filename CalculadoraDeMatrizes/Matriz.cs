...
namespace CalculadoraDeMatrizes
{
    static class Matriz
    {
        ...
        /// </summary>
        /// <param name="lei">String formula para gerar a matriz</param>
        ...
        /// <summary>
        /// Função para tirar linhas e colunas de uma matriz
        /// </summary>
        /// <param name="rowToRemove">Linha para romver da matriz</param>
        /// <param name="columnToRemove">Coluna para remover da matriz</param>
        /// <param name="originalArray">Matriz Original</param>
        /// <returns>Retorna a matriz sem a linha e a coluna especificadas</returns>
        static float[,] TrimArray(int rowToRemove, int columnToRemove, float[,] originalArray)
        {
        ...
        /// <summary>
        /// Função para checar se a matriz é simetrica ou não
        /// </summary>
        /// <param name="matriz">Matriz para checar sua simetria</param>
        /// <returns>Retorna um valor booleano que diz se a matriz é simetrica ou não</returns>
        public static bool ChecarSimetria(float[,] matriz)
        {
            float[,] transposta = MatrizTransposta(matriz);
            int max = matriz.GetLength(0) * matriz.GetLength(1);
            int count = 0;
            if(transposta.GetLength(0) != matriz.GetLength(0))
            {
                return false;
            }
            else
